...
# Code starts here
# compute_coherence_values(dictionary=dictionary,corpus=doc_term_matrix,texts=doc_clean,limit=1,start=41,step=5)
# # opt_topic=
# max_index=coherence_value_list.index(max(coherence_values))
